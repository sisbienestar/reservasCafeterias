 ...
 */
function par(etiqueta: string, valor: string): string[] {
 ...
 */
export function construirTicket(reserva: Reserva, cafeteria: { nombre: string }): string {
 ...
 */
export function mensajeWhatsApp(reserva: Reserva, cafeteria: { nombre: string }): string {
 ...
 *
 * Devuelve null si el móvil no sirve para escribir por WhatsApp.
 */
export function enlaceWhatsApp(
  reserva: Reserva,
  cafeteria: { nombre: string },
  indicativo = '57',
): string | null {
